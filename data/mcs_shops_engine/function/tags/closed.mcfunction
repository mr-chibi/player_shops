...
execute if score shop_particles mcs_particles matches 1 as @e[type=minecraft:marker,distance=0..8,sort=nearest,tag=mcs_shops,nbt={data:{"shop_status":"closed"}}] at @s run particle minecraft:end_rod ^ ^ ^5 0.25 0.50 0.50 0 15 force @a
