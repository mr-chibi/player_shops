...
# Error, Check #1:
execute as @e[type=minecraft:marker,tag=ps_shop] at @s if data entity @s {data:{ps_status:"lock"}} unless data entity @s data.ps_buy[3].id run tellraw @p[distance=0..2,scores={ps_distance=0..2}] [{"text": "[", "color": "white"}, {"text": "Mr_Chibi's Player Shop", "color": "#FF2682"}, {"text": "] ", "color": "white"}, {"text": "Error, shop buy slot is empty!", "color": "#A3A3A3"}]
execute as @e[type=minecraft:marker,tag=ps_shop] at @s if data entity @s {data:{ps_status:"lock"}} unless data entity @s data.ps_buy[3].id run scoreboard players add @p[distance=0..2,scores={ps_distance=0..2}] ps_error 1

# Error, Check #2:
execute as @e[type=minecraft:marker,tag=ps_shop] at @s if data entity @s {data:{ps_status:"lock"}} unless data entity @s data.ps_sell[3].id run tellraw @p[distance=0..2,scores={ps_distance=0..2}] [{"text": "[", "color": "white"}, {"text": "Mr_Chibi's Player Shop", "color": "#FF2682"}, {"text": "] ", "color": "white"}, {"text": "Error, sell slot is empty!", "color": "#A3A3A3"}]
execute as @e[type=minecraft:marker,tag=ps_shop] at @s if data entity @s {data:{ps_status:"lock"}} unless data entity @s data.ps_sell[3].id run scoreboard players add @p[distance=0..2,scores={ps_distance=0..2}] ps_error 1
