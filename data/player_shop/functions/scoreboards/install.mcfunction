...
scoreboard objectives add ps_slot_3 dummy
scoreboard objectives add ps_slot_4 dummy
scoreboard objectives add ps_slot_5 dummy
scoreboard objectives add ps_slot_6 dummy
scoreboard objectives add ps_slot_7 dummy
scoreboard objectives add ps_slot_8 dummy
