...
execute unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:5b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:15b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:16b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:17b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:24b}]} run data modify entity @s Offers.Recipes[2].sell merge from block ~ ~-1 ~ Items[{Slot:25b}]
execute unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:5b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:15b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:16b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:17b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:24b}]} unless block ~ ~-1 ~ minecraft:chest{Items:[{Slot:25b}]} run data modify entity @s Offers.Recipes[2].sell merge from block ~ ~-1 ~ Items[{Slot:26b}]
